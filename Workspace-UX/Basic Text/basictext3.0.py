...
button_frame = Frame(root)
button_frame.pack(pady=7, fill=X, side=TOP)
...
print("hello and thanks for opening text editor. Also make sure to check out til intepreter to wirte manuals!")